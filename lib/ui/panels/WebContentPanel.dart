  ...
  Widget build(BuildContext context) {
    ...
    if (_onlineStatus == _OnlineStatus.checking) {
      return Scaffold(
        ...
        body: ModalProgressHUD(child: Center(child: Text('Please Wait...', style: TextStyle(fontFamily: 'Avenir', fontWeight:FontWeight.w700, fontSize: 32, color: Colors.black, ),)), inAsyncCall: true));
    }
      ...
      return Scaffold(
        ...
        body: Center(child: Container(width: 280, child: Text('You need to be online in order to perform this operation. Please check your Internet connection.', textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Avenir', fontWeight:FontWeight.w500, fontSize: 18, color: Colors.black, ),)), ));
    }
    else {
      return Scaffold(
        appBar: AppBar(
        ...
        body: Center(child: Center(child: Text('Please Wait...', style: TextStyle(fontFamily: 'Avenir', fontWeight:FontWeight.w700, fontSize: 32, color: Colors.black, ),)), ));
    }
