...
class WidgetHelper {
  static List<Widget> createPanelContentFor(
      ...
      double widgetsInnerGutter,
      Role role,
      GestureTapCallback editProfileTapGesture) {
    ...
    widgets.forEach((widgetEntry) {
      ...
      if (destinationType == 'panel' && destinationValue == 'edit') {
        ...
        tapGesture = _getTapGesture(
            context, destinationType, destinationValue, destinationTitle);
      }
  ...
  static GestureTapCallback parseWidgetGesture(
      BuildContext context, Map<String, dynamic> widgetDestination) {
    String destinationType;
    String destinationValue;
    String destinationTitle;
    if (widgetDestination != null) {
  ...
  static void _openMapsPanel(
      BuildContext context, String title, String destination) {
    ...
    Navigator.push(
        context,
        MaterialPageRoute(
            builder: (context) => new MapsPanel(pos: location, title: title)));
  }
